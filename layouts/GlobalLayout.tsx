          ...
          <nav className="hidden lg:flex items-center gap-8 xl:gap-12">
            {items.map((item) => (
              <Link
                key={item.path}
                to={item.path}
                className={`text-[10px] xl:text-[11px] font-black uppercase tracking-[0.3em] transition-all relative group ${
            ...
            <nav className="flex flex-col gap-6">
              {items.map((item) => (
                <Link
                  key={item.path}
                  to={item.path}
                  className={`flex items-center gap-4 text-sm font-black uppercase tracking-widest ${
